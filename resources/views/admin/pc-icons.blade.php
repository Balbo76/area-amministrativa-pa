    ...
    <div class="container my-5">
        ...
        <div class="row mb-5">
            <div class="col-12 border-bottom pb-3">
                ...
                <p class="lead">Demo completa dei componenti <code>&lt;x-pc-icon&gt;</code> integrati con il design system di Bootstrap Italia.</p>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-12">
                ...
                <div class="alert alert-danger d-flex align-items-center mb-3" role="alert">
                    ...
                    <div>
                        <strong>Stato di Allerta Attiva:</strong> È in corso un evento meteo critico. Consulta le norme di comportamento.
                    </div>
                </div>
        ...
        <div class="row mb-5">
            <div class="col-12">
                ...
                <p class="text-muted">Esempio di utilizzo delle icone di rischio combinate con i colori di criticità del Centro Funzionale Decentrato Veneto.</p>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><x-pc-icon name="rischio-idrogeologico" size="icon-md" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><x-pc-icon name="rischio-meteo" size="icon-md" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><x-pc-icon name="rischio-sismico" size="icon-md" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><x-pc-icon name="rischio-incendi" size="icon-md" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><x-pc-icon name="rischio-neve" size="icon-md" /></td>
                            <td>
                ...
                <div class="card card-space shadow-sm border-start border-primary border-4">
                    <div class="card-body d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <p class="card-text small text-muted">Punti di primo ritrovo per la popolazione in caso di evacuazione di emergenza.</p>
                ...
                <div class="card card-space shadow-sm border-start border-warning border-4">
                    <div class="card-body d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <p class="card-text small text-muted">Aree per l'allestimento di tendopoli, strutture ricettive o campi di accoglienza sfollati.</p>
                ...
                <div class="card card-space shadow-sm border-start border-secondary border-4">
                    <div class="card-body d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <p class="card-text small text-muted">Hub logistici riservati all'arrivo dei soccorritori e delle colonne mobili d'aiuto.</p>
            ...
            <div class="col-md-6 mb-3">
                <div class="p-3 border rounded bg-light d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-muted small">Contatti e sedi dei Centri Operativi Comunali attivati dai Sindaci.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="p-3 border rounded bg-light d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-muted small">Mappa dei distretti, dei magazzini e delle sedi dei volontari tute gialle.</p>
                    </div>
                </div>
            </div>
        </div>
